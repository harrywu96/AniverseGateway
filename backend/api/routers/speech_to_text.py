...
from backend.schemas.config import SystemConfig, SpeechToTextConfig
...
async def transcribe_with_local_model(
    ...
    try:
        ...
        # 创建转写参数
        from backend.core.speech_to_text import TranscriptionParameters
        ...
        # 创建SpeechToText实例
        from backend.core.speech_to_text import SpeechToText
