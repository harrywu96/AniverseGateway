...
from backend.schemas.api import APIResponse, ProgressUpdateEvent, ErrorResponse
from backend.schemas.task import SubtitleTask, TranslationConfig, TaskStatus
...
from backend.api.websocket import manager  # 从websocket模块导入manager
