...
from backend.schemas.video import VideoInfo
from backend.schemas.task import SubtitleTask
...
class TaskCreateRequest(BaseModel):
    ...
    translation_config: Optional[Dict[str, Any]] = Field(
        None, description="翻译配置"
    )
