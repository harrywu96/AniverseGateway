...
export const API_PATHS = {
    ...
    VIDEOS_DETAIL: (id) => `/api/videos/${id}`,
    SUBTITLES: '/api/subtitles',
    SUBTITLES_EXTRACT: '/api/subtitles/extract',
    SUBTITLES_DETAIL: (id) => `/api/subtitles/${id}`,
    TASKS: '/api/tasks',
    TASKS_DETAIL: (id) => `/api/tasks/${id}`,
    TRANSLATE: '/api/translate',
    CONFIG: '/api/config',
    CONFIG_UPDATE: '/api/config/update',
    PROVIDERS: '/api/providers',
    MODELS: (provider) => `/api/providers/${provider}/models`,
    TEMPLATES: '/api/templates',
    TEMPLATES_DETAIL: (id) => `/api/templates/${id}`,
    EXPORT: '/api/export',
