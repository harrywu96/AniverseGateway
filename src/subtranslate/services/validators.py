...
class TranslationValidator:
    ...
    def validate_single_translation(
        ...
        if ratio < 0.3:
            ...
            warnings.append(f"翻译可能包含额外内容，长度比例过高 ({ratio:.2f})")
            score -= 15.0
    ...
    def _check_glossary_terms(self, original: str, translation: str) -> List[str]:
        """检查术语表中的术语是否正确翻译
    ...
    def validate_multiple_translations(
        ...
        for i, (original, translation) in enumerate(zip(originals, translations)):
